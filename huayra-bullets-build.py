...
bullets_mate = [
	[
      ...
      [
        ...
        [
        '¿Cómo recupero archivos borrados?',
        '<p>En <a href="[exec]caja trash://">la papelera</a> selecciono el archivo borrado y hago clic en <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Archivos-y-carpetas#sec:Recuperar-un-archivo">"Restaurar los elementos seleccionados"</a>. De esa manera, el archivo irá a su carpeta original.</p>',
        '01',
        '01',
    ],
        [
        ...
        [
        '¿Cuánta batería me queda?',
        '<p>El ícono de <a href="[doc]/usr/share/huayra/help/ayuda.xml#energia">batería</a> en el <a href="[doc]/usr/share/huayra/help/ayuda.xml#paneles#panel-superior"> Panel Superior</a> a la derecha me lo indica al hacer clic. Desde <a href="[exec]mate-control-center"> Configuración del sistema</a> puedo optimizar el uso haciendo clic en "Gestor de energía".</p>',
        '01',
        '01',
    ],
      [
