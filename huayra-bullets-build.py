...
bullets = [
	...
	[
		...
		'<p>Hacé clic en "Huayra" en la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior">barra superior</a> a la izquierda y se despliega el <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Men-Huayra-1">Menú Huayra</a>. A la izquierda están <a href="[doc]/usr/share/huayra/help/ayuda.xml#//autoid-72#sec:Marcadores-de-carpeta">los marcadores </a> de carpetas que más usás y a la derecha las aplicaciones. Arriba podés buscar aplicaciones o ver las más usadas con Favoritas.</p>',
		'01',
		'01',
	],
	[
	...
	[
		...
		'<p>Lo que antes hacías con Microsoft Word ahora lo podés hacer con <a href="[exec]loffice">Libre Office Writer</a>. <a href="[doc]/usr/share/huayra/help/ayuda.xml#sec:Dnde-encuentro-en-32">¿Dónde encuentro en Huayra los otros programas que más usaba en Windows?</a></p>',
		'01',
		'01',
	],
		[
	...
	[
		...
		'<p>Es sencillo como eso, con Huayra no hay virus. Los diferentes permisos bloquean toda actividad nociva y las rápidas actualizaciones de la comunidad del <a href="[doc]/usr/share/huayra/help/ayuda.xml#//autoid-337#//autoid-369">Software Libre</a> eliminan toda amenaza.</p>',
		'01',
		'01',
	],
	[
		'¿Cómo me conecto a Internet?',
		'<p>Hago clic en el ícono de <a href="[doc]/usr/share/huayra/help/ayuda.xml#part:Internet-y-conectividad">conexiones</a> en la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior">barra superior</a> a la derecha y elejo la red (WiFi o cableada) La primera vez que me conecte tengo que ingresar mi <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Cuentas-de-usuario#//autoid-49">contraseña</a> (-alumno- por default).</p>',
		'01',
		'01',
	],
	[
		'¿Cómo configuro mi escritorio?',
		'<p>En <a href="[exec]gnome-tweak-tool"> Configuración avanzada</a> (<a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Men-Huayra-1">Menú Huayra</a>/Preferencias) puedo cambiar el aspecto de iconos y ventanas y otras configuraciones de escritorio. <a href="[doc]/usr/share/huayra/help/ayuda.xml#part:Tune-tu-escritorio-13">Con Huayra ningún escritorio es igual a otro</a>.</p>',
		'01',
		'01',
	],
	[
	...
	[
		...
		'<p>Huayra detecta el pen-drive automáticamente y muestra un recuadro en la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-inferior#//autoid-12">Barra de notificaciones</a> desde donde podés abrir el contenido. Expulsalo de forma segura con haciendo clic con el botón derecho en el ícono del pen que está en el escritorio.</p>',
		'01',
		'01',
	],
	[
	...
	[
		...
		'<p>En <a href="[exec]nautilus trash://">la papelera</a> selecciono el archivo borrado y hago clic en "Restaurar los elementos seleccionados". De esa manera, <a href="[doc]/usr/share/huayra/help/ayuda.xml#//autoid-76">el archivo</a> irá a su carpeta original.</p>',
		'01',
		'01',
	],
	[
	...
	[
		...
		'<p>Hago clic en la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior">barra superior</a> donde aparece la fecha y la hora, luego en "Ajustes de fecha y hora". También puedo modificar la fecha y la hora en <a href="[exec]gnome-control-center"> Configuración del sistema</a> / Fecha y Hora (en el <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior#sec:Men-de-usuario-9"> Menú de usuario </a>)</p>',
		'01',
		'01',
	],
	[
		'¿Cuánta batería me queda?',
		'<p>El ícono de <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Energa-y-Batera-7">batería</a> en la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior">barra superior</a> a la derecha me lo indica al hacer clic. Desde <a href="[exec]gnome-control-center"> Configuración del sistema</a> (en <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Barra-superior#sec:Men-de-usuario-9"> Menú de usuario </a> arriba a la derecha) puedo optimizar el uso de la <a href="[doc]/usr/share/huayra/help/ayuda.xml#chap:Energa-y-Batera-7">Batería</a>.</p>',
		'01',
		'01',
	],
	[
	...
	[
		'¿Como escucho musica?',
		'<p>Con un simple doble clic en el archivo de música se abre el reproductor <a href="[doc]/usr/share/huayra/help/ayuda.xml#//autoid-379#sec:Clementine">Clementine</a> desde donde puedo administrar mis discos, listas y mucho más. Puedo <a href="[doc]/usr/share/huayra/help/ayuda.xml#sec:Abrir-archivos-con">cambiar la aplicación predeterminada</a> para abrir mi música.</p>',
		'01',
		'01',
	],
	[
	...
	[
		...
		'<p>Simplemente hago clic con el botón derecho y elijo la opción <a href="[doc]/usr/share/huayra/help/ayuda.xml#//autoid-76#sec:Comprimir-y-descomprimir">"Comprimir"</a>. Luego elijo el nombre del archivo final y la extensión (zip, rar, 7z, tar.gz etc.). La opción 7z que es la que más y mejor comprime.</p>',
		'01',
		'01',
	],
]
