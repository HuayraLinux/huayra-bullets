...
bullets_mate = [
    ...
    [
        ...
        '<p>Desde el Centro de software instalá todos los programas en sus versiones oficiales y libres. Podés buscar por tema o por categoría.<br><br>1- Andá al <a href="[doc]/articles/c/e/n/Centro_de_control.html">Centro de control</a> y después a <a href="/articles/c/e/n/Centro_de_Software.html">Centro de Software</a><br>2- Buscá aplicaciones por nombre o tema<br>3- Hacé clic en <a href="/articles/%C2%BF/c/%C3%B3/%C2%BFC%C3%B3mo_instalar/desinstalar_aplicaciones_en_Huayra%3F.html">Instalar</a></p>',
        '01',
        '01',
    ],
    [
        '7- Encontrá en Huayra todos los programas que usabas en Windows',
        '<p>Lo que antes hacías con Microsoft Word ahora lo podés hacer con Libre Office Writer. <a href="/articles/%C2%BF/d/%C3%B3/%C2%BFD%C3%B3nde_encuentro_en_Huayra_GNU/Linux_los_programas_que_m%C3%A1s_usaba_en_MS_Windows%3F.html">¿Dónde encuentro en Huayra los otros programas que más usaba en Windows?</a> </p>',
        '01',
        '01',
    ],
    [
        '8- Mirá la Televisión Digital Abierta TDA en Huayra',
        '<p>Con Huayra accedé a todos los canales de la <a href="/articles/t/e/l/Televisi%C3%B3n_Digital_Argentina-_TDA.html">TDA</a><br><br>1- Conectá la antena<br>2- Hacé clic en el ícono de Wari del dock<br>3- La primera vez que lo abras escanea los canales<br>4- Elegí qué canales ver</p>',
        '01',
        '01',
    ],
    [
